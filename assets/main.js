(function () {
    ...
    for (const r of document.querySelectorAll('link[rel="modulepreload"]')) $(r);
    new MutationObserver((r) => {
        for (const o of r)
            if (o.type === "childList")
                for (const a of o.addedNodes)
                    a.tagName === "LINK" && a.rel === "modulepreload" && $(a);
    }).observe(document, {
        childList: !0,
        subtree: !0,
    });
...
var w2 = new Set(X1.map((s) => s.iso2)),
    E1 = (s) => w2.has(s),
    T1 = X1,
    b1 = {
    ...
    j1 = (s) =>
        ...
        window.matchMedia(s).matches,
    Q0 = () => j1(`(max-width: ${Z.NARROW_VIEWPORT_WIDTH}px)`),
    D2 = () => {
        if (typeof navigator < "u" && typeof window < "u") {
            const s = j1("(max-height: 600px)"),
                t = j1("(pointer: coarse)");
            return Q0() || (t && s);
        }
        return !1;
    ...
    z1 = {
        ...
        showFlags: !0,
        strictMode: !1,
        useFullscreenPopup: D2(),
    },
    d2 = (s) => JSON.stringify(s),
    U0 = (s) => !!s && typeof s == "object" && !Array.isArray(s),
    T2 = (s) => typeof s == "function",
    _2 = (s) => {
        if (!s || typeof s != "object") return !1;
        const t = s;
        return (
            t.nodeType === 1 && typeof t.tagName == "string" && typeof t.appendChild == "function"
        );
    },
    H0 = new Set(Object.values(_1)),
    O1 = (s) => {
        console.warn(`[intl-tel-input] ${s}`);
    },
    W = (s, t, n) => {
        O1(`Option '${s}' must be ${t}; got ${d2(n)}. Ignoring.`);
    },
    k0 = (s, t) => {
        const n = "an array of ISO2 country code strings";
        if (!Array.isArray(t)) return (W(s, n, t), !1);
        const $ = [];
        for (const r of t) {
            if (typeof r != "string") return (W(s, n, t), !1);
            const o = r.toLowerCase();
            E1(o) ? $.push(r) : O1(`Invalid country code in '${s}': '${r}'. Skipping.`);
        }
        return $;
    },
    O2 = (s) => {
        if (s === void 0) return {};
        if (!U0(s)) {
            const n = `The second argument must be an options object; got ${d2(s)}. Using defaults.`;
            return (O1(n), {});
        }
        const t = {};
        for (const [n, $] of Object.entries(s)) {
            if (!Object.hasOwn(z1, n)) {
                O1(`Unknown option '${n}'. Ignoring.`);
                continue;
            }
            switch (n) {
                case "allowDropdown":
                ...
                case "autoPlaceholder":
                    if (typeof $ != "string" || !H0.has($)) {
                        const r = Array.from(H0).join(", ");
                        W("autoPlaceholder", `one of ${r}`, $);
                        break;
                    }
                    t[n] = $;
                    break;
                ...
                case "dropdownContainer":
                    if ($ !== null && !_2($)) {
                        W("dropdownContainer", "an HTMLElement or null", $);
                        break;
                    }
                    t[n] = $;
                    break;
                ...
                case "initialCountry": {
                    if (typeof $ != "string") {
                        W("initialCountry", "a string", $);
                        break;
                    }
                    const r = $.toLowerCase();
                    if (r && r !== K1.AUTO && !E1(r)) {
                        W("initialCountry", "a valid ISO2 country code or 'auto'", $);
                        break;
                    }
                    t[n] = $;
                    break;
                ...
                case "placeholderNumberType":
                    if (typeof $ != "string" || !D1.has($)) {
                        const r = Array.from(D1).join(", ");
                        W("placeholderNumberType", `one of ${r}`, $);
                        break;
                    }
                    t[n] = $;
                    break;
                case "allowedNumberTypes":
                    if ($ !== null) {
                        if (!Array.isArray($)) {
                            W("allowedNumberTypes", "an array of number types or null", $);
                            break;
                        }
                        let r = !0;
                        for (const o of $)
                            if (typeof o != "string" || !D1.has(o)) {
                                const a = Array.from(D1).join(", ");
                                (W(
                                    "allowedNumberTypes",
                                    `an array of valid number types (${a})`,
                                    o,
                                ),
                                    (r = !1));
                                break;
    ...
    P2 = (s) => {
        (s.initialCountry && (s.initialCountry = s.initialCountry.toLowerCase()),
            s.onlyCountries?.length &&
                (s.onlyCountries = s.onlyCountries.map((t) => t.toLowerCase())),
            s.excludeCountries?.length &&
                (s.excludeCountries = s.excludeCountries.map((t) => t.toLowerCase())),
            s.countryOrder && (s.countryOrder = s.countryOrder.map((t) => t.toLowerCase())));
    },
    R2 = (s) => {
        (s.dropdownAlwaysOpen && ((s.useFullscreenPopup = !1), (s.allowDropdown = !0)),
            s.useFullscreenPopup ? (s.fixDropdownWidth = !1) : Q0() && (s.fixDropdownWidth = !0),
            s.onlyCountries?.length === 1 && (s.initialCountry = s.onlyCountries[0]),
            s.separateDialCode && (s.nationalMode = !1),
            s.allowDropdown && !s.showFlags && !s.separateDialCode && (s.nationalMode = !1),
            s.useFullscreenPopup && !s.dropdownContainer && (s.dropdownContainer = document.body),
            (s.i18n = {
                ...b2,
                ...s.i18n,
            }));
    ...
    M2 = (s, t) => {
        ...
        for (const y of s)
            y.iso2 === n
                ? $.push(y)
                : y.normalisedName.startsWith(n)
                  ? r.push(y)
                  : y.normalisedName.includes(n)
                    ? o.push(y)
                    : n === y.dialCode || n === y.dialCodePlus
                      ? a.push(y)
                      : y.dialCodePlus.includes(n)
                        ? p.push(y)
                        : y.initials.includes(n) && g.push(y);
        const C = (y, v) => y.priority - v.priority;
        return [...$, ...r, ...o, ...a.sort(C), ...p.sort(C), ...g];
    },
    x2 = (s, t) => {
        const n = J1(t);
        for (const $ of s) if ($.normalisedName.startsWith(n)) return $;
        return null;
    },
    G1 = (s) =>
        Object.keys(s)
            ...
            .join(" "),
    N = (s, t, n) => {
        const $ = document.createElement(s);
        return (
            t && Object.entries(t).forEach(([r, o]) => $.setAttribute(r, o)),
            n && n.appendChild($),
            $
        );
    },
  ...
  <svg class="iti__search-icon-svg" width="14" height="14" viewBox="0 0 24 24" focusable="false" ${A.HIDDEN}="true">
    ...
    H2 = () => `
  <svg class="iti__country-check-svg" width="14" height="14" viewBox="0 0 16 16" fill="currentColor" focusable="false" ${A.HIDDEN}="true">
  ...
  <svg width="256" height="256" viewBox="0 0 512 512" class="iti__globe-svg">
    ...
    W0 = class Y1 {
        ...
        constructor(t, n, $) {
            ((t.dataset.intlTelInputId = $.toString()),
                (this.telInput = t),
                (this.#d = n),
                (this.#t = $),
                (this.hadInitialPlaceholder = !!t.getAttribute("placeholder")),
                (this.#m = !!this.telInput.closest("[dir=rtl]")),
                this.#d.separateDialCode && (this.#l = this.telInput.style.paddingLeft));
        }
        static validateInput(t) {
            ...
            if (
                ...
                throw new TypeError(`The first argument must be an HTMLInputElement, not ${r}`);
            }
        }
        generateMarkup(t) {
            ((this.#h = t),
                this.telInput.classList.add("iti__tel-input"),
                this.telInput.hasAttribute("type") || this.telInput.setAttribute("type", "tel"),
            ...
            const n = this.#c();
            (this.#o(n), n.appendChild(this.telInput), this.#P(), this.#R(n));
        }
        #c() {
            const {
                    allowDropdown: t,
            ...
            return (this.#m && a.setAttribute("dir", "ltr"), this.telInput.before(a), a);
        }
        #o(t) {
            const { allowDropdown: n, separateDialCode: $, showFlags: r } = this.#d;
            if (!n && !r && !$) return;
            ((this.countryContainer = N(
                "div",
                {
                    class: `iti__country-container ${S.V_HIDE}`,
                },
                t,
            )),
                n
                    ? ((this.selectedCountry = N(
                          "button",
                          {
                              ...
                              [A.EXPANDED]: "false",
                              [A.LABEL]: this.#d.i18n.noCountrySelected,
                              [A.HASPOPUP]: "dialog",
                              [A.CONTROLS]: `iti-${this.#t}__dropdown-content`,
                          },
        ...
        maybeEnsureDropdownWidthSet() {
            const { fixDropdownWidth: t, allowDropdown: n } = this.#d;
            if (!n || !t || this.#n.style.width) return;
            const $ = this.telInput.offsetWidth;
            $ > 0 && (this.#n.style.width = `${$}px`);
        }
        #f() {
            const {
                    fixDropdownWidth: t,
                ...
                p = t ? "" : "iti--flexible-dropdown-width";
            if (
                ((this.#n = N("div", {
                    id: `iti-${this.#t}__dropdown-content`,
                    class: `iti__dropdown-content ${S.HIDE} ${p}`,
                    role: "dialog",
                    [A.MODAL]: "true",
                })),
                this.#m && this.#n.setAttribute("dir", "rtl"),
                $ && this.#O(),
                (this.countryList = N(
                    "ul",
                    {
                        ...
                        role: "listbox",
                        [A.LABEL]: r.countryListAriaLabel,
                    },
                    this.#n,
                )),
                this.#L(),
                $ && this.#A(),
                n || ((this.#y = this.#x()), $ && (this.#n.style.height = `${this.#y}px`)),
                o)
            ) {
                const g = G1({
                    iti: !0,
            ...
            } else this.countryContainer.appendChild(this.#n);
        }
        #O() {
            const { i18n: t, searchInputClass: n } = this.#d,
                $ = N(
                    "div",
                    {
            ...
            ((this.#u = N(
                ...
                (this.searchInput = N(
                    "input",
                    {
                        ...
                        [A.CONTROLS]: `iti-${this.#t}__country-listbox`,
                        [A.AUTOCOMPLETE]: "list",
                        autocomplete: "off",
                    },
                    $,
                ...
                (this.searchClearButton = N(
                    ...
                    {
                        type: "button",
                        class: `iti__search-clear ${S.HIDE}`,
                        [A.LABEL]: t.clearSearchAriaLabel,
                        tabindex: "-1",
                    },
                    $,
                )),
                (this.searchClearButton.innerHTML = U2(this.#t)),
                (this.#a = N(
                    "span",
                    {
                ...
                (this.#$ = N(
                    "div",
                    {
                        class: `iti__no-results ${S.HIDE}`,
                        [A.HIDDEN]: "true",
                    },
                    this.#n,
                )),
                (this.#$.textContent = t.searchEmptyState ?? null));
        }
        #P() {
            this.countryContainer && (this.#w(), this.countryContainer.classList.remove(S.V_HIDE));
        }
        #R(t) {
            const { hiddenInput: n } = this.#d;
            if (!n) return;
            const $ = this.telInput.getAttribute("name") || "",
                r = n($);
            if (r.phone) {
                const o = this.telInput.form?.querySelector(`input[name="${r.phone}"]`);
                o
                    ? (this.hiddenInputPhone = o)
                    : ((this.hiddenInputPhone = N("input", {
                          type: "hidden",
                          name: r.phone,
                      })),
                      t.appendChild(this.hiddenInputPhone));
            }
            if (r.country) {
                const o = this.telInput.form?.querySelector(`input[name="${r.country}"]`);
                o
                    ? (this.hiddenInputCountry = o)
                    : ((this.hiddenInputCountry = N("input", {
                          type: "hidden",
                          name: r.country,
                      })),
        ...
        #L() {
            ...
            for (let n = 0; n < this.#h.length; n++) {
                const $ = this.#h[n],
                    r = G1({
                        [S.COUNTRY_ITEM]: !0,
                    }),
                    o = N("li", {
                        id: `iti-${this.#t}__item-${$.iso2}`,
                        class: r,
                        tabindex: "-1",
                        role: "option",
                        [A.SELECTED]: "false",
                    });
                ((o.dataset.dialCode = $.dialCode),
                    (o.dataset.countryCode = $.iso2),
                    ($.nodeById[this.#t] = o),
                    this.#d.showFlags &&
                        N(
                            "div",
                            {
                                class: `${S.FLAG} iti__${$.iso2}`,
                            },
                            o,
                        ));
                const a = N(
                ...
                (this.#m && p.setAttribute("dir", "ltr"),
                    (p.textContent = `(+${$.dialCode})`),
                    t.appendChild(o));
            }
        ...
        #w() {
            if (this.selectedCountry) {
                const t = this.#d.separateDialCode
                        ? Z.SANE_SELECTED_WITH_DIAL_WIDTH
                        : Z.SANE_SELECTED_NO_DIAL_WIDTH,
                    $ =
                        (this.selectedCountry.offsetWidth || this.#M() || t) +
                        Z.INPUT_PADDING_EXTRA_LEFT;
                this.telInput.style.paddingLeft = `${$}px`;
            }
        }
        static #F() {
            let t;
        ...
        #M() {
            ...
            const t = Y1.#F(),
                n = this.telInput.parentNode.cloneNode(!1);
            ((n.style.visibility = "hidden"), t.appendChild(n));
            const $ = this.countryContainer.cloneNode();
            n.appendChild($);
        ...
        #x() {
            const t = Y1.#F();
            this.#n.classList.remove(S.HIDE);
            const n = N("div", {
                class: "iti iti--inline-dropdown",
            });
            (n.appendChild(this.#n), (n.style.visibility = "hidden"), t.appendChild(n));
            const $ = this.#n.offsetHeight;
            return (
                t.removeChild(n),
                (n.style.visibility = ""),
                this.#n.classList.add(S.HIDE),
                $ > 0 ? $ : Z.SANE_DROPDOWN_HEIGHT
            );
        }
        #A() {
            const { i18n: t } = this.#d,
                n = this.countryList.childElementCount;
            this.#a.textContent = t.searchSummaryAria(n);
        }
        filterCountriesByQuery(t) {
            let n;
            (t === "" ? (n = this.#h) : (n = M2(this.#h, t)), this.#U(n));
        }
        #E() {
            const t = this.searchInput.value.trim();
            (this.filterCountriesByQuery(t),
                this.searchInput.value
                    ? this.searchClearButton.classList.remove(S.HIDE)
                    : this.searchClearButton.classList.add(S.HIDE));
        }
        handleSearchChange() {
            (this.#p && clearTimeout(this.#p),
                (this.#p = setTimeout(() => {
                    (this.#E(), (this.#p = null));
                }, z0.SEARCH_DEBOUNCE_MS)));
        }
        handleSearchClear() {
            ((this.searchInput.value = ""), this.searchInput.focus(), this.#E());
        }
        scrollCountryListToItem(t) {
            const n = this.countryList,
                $ = n.getBoundingClientRect(),
                r = t.getBoundingClientRect(),
                o = r.top - $.top + n.scrollTop;
            r.top < $.top
                ? (n.scrollTop = o)
                : r.bottom > $.bottom && (n.scrollTop = o - $.height + r.height);
        }
        highlightListItem(t, n) {
            const $ = this.highlightedItem;
            if (
                ($ && $.classList.remove(S.HIGHLIGHT),
                (this.highlightedItem = t),
                this.highlightedItem)
            ) {
                if ((this.highlightedItem.classList.add(S.HIGHLIGHT), this.#d.countrySearch)) {
                    const r = this.highlightedItem.getAttribute("id") || "";
                    this.searchInput.setAttribute(A.ACTIVE_DESCENDANT, r);
                }
        ...
        handleUpDownKey(t) {
            ...
            (!n &&
                ...
                n && (this.scrollCountryListToItem(n), this.highlightListItem(n, !1)));
        }
        #B(t) {
            if (
                (this.#s &&
                    this.#s.dataset.countryCode !== t &&
                    (this.#s.setAttribute(A.SELECTED, "false"),
                    this.#s.querySelector(".iti__country-check")?.remove(),
                    (this.#s = null)),
                t && !this.#s)
            ) {
                const n = this.countryList.querySelector(`[data-country-code="${t}"]`);
                if (n) {
                    n.setAttribute(A.SELECTED, "true");
                    const $ = N(
                        "span",
                        {
        ...
        #U(t) {
            ...
            let n = !0;
            for (const $ of t) {
                const r = $.nodeById[this.#t];
                r &&
                    (this.countryList.appendChild(r),
                    n && (this.highlightListItem(r, !1), (n = !1)));
            }
            (n
                ? (this.highlightListItem(null, !1), this.#$ && this.#$.classList.remove(S.HIDE))
                : this.#$ && this.#$.classList.add(S.HIDE),
        ...
        destroy() {
            ((this.telInput.iti = void 0),
                ...
                this.#d.separateDialCode && (this.telInput.style.paddingLeft = this.#l));
            const t = this.telInput.parentNode;
            t && (t.before(this.telInput), t.remove());
            for (const n of this.#h) delete n.nodeById[this.#t];
        }
        openDropdown() {
            const { countrySearch: t, dropdownAlwaysOpen: n, dropdownContainer: $ } = this.#d;
            if ((this.maybeEnsureDropdownWidthSet(), $)) this.#H();
            else {
                const o = this.#N(),
                    a = this.telInput.offsetHeight + Z.DROPDOWN_MARGIN;
                o ? (this.#n.style.top = `${a}px`) : (this.#n.style.bottom = `${a}px`);
            }
            (this.#n.classList.remove(S.HIDE),
                this.selectedCountry.setAttribute(A.EXPANDED, "true"));
            const r = this.#s ?? this.countryList.firstElementChild;
            (r && (this.highlightListItem(r, !1), this.scrollCountryListToItem(r)),
                t && !n && this.searchInput.focus(),
                this.#d.useFullscreenPopup &&
                    ...
                    window.visualViewport.addEventListener("resize", this.#r)),
                this.#e.classList.add(S.ARROW_UP));
        }
        closeDropdown() {
            const { countrySearch: t, dropdownContainer: n } = this.#d;
            (this.#n.classList.add(S.HIDE),
                this.selectedCountry.setAttribute(A.EXPANDED, "false"),
                t &&
                    (this.searchInput.removeAttribute(A.ACTIVE_DESCENDANT),
                    (this.searchInput.value = ""),
                    this.#E(),
                    this.highlightedItem &&
                        (this.highlightedItem.classList.remove(S.HIGHLIGHT),
                        (this.highlightedItem = null))),
                this.#e.classList.remove(S.ARROW_UP),
                this.#r &&
                    window.visualViewport &&
                    (window.visualViewport.removeEventListener("resize", this.#r),
                    (this.#r = null)),
                n
                    ? (this.#i.remove(),
                      (this.#i.style.top = ""),
                    ...
                    : ((this.#n.style.top = ""), (this.#n.style.bottom = "")));
        }
        #N() {
            if (this.#d.dropdownAlwaysOpen) return !0;
        ...
        #H() {
            const { dropdownContainer: t, useFullscreenPopup: n } = this.#d;
            if (n) {
                if (window.innerWidth >= Z.NARROW_VIEWPORT_WIDTH) {
                    const $ = this.telInput.getBoundingClientRect();
                    ((this.#i.style.paddingLeft = `${$.left}px`),
                        (this.#i.style.paddingRight = `${window.innerWidth - $.right}px`));
                }
            } else {
                const $ = this.telInput.getBoundingClientRect();
                ((this.#i.style.left = `${$.left}px`),
                    this.#N()
                        ? (this.#i.style.top = `${$.bottom + Z.DROPDOWN_MARGIN}px`)
                        : ((this.#i.style.top = "unset"),
                          (this.#i.style.bottom = `${window.innerHeight - $.top + Z.DROPDOWN_MARGIN}px`)));
            }
            t.appendChild(this.#i);
        }
        #k() {
            const t = window.visualViewport;
            if (!t || !this.#i) return;
            const n = window.innerHeight - t.height;
            this.#i.style.bottom = `${n}px`;
        }
        isDropdownClosed() {
            return this.#n.classList.contains(S.HIDE);
        }
        setCountry(t) {
            const { allowDropdown: n, showFlags: $, separateDialCode: r, i18n: o } = this.#d,
                a = t?.name,
                p = t?.dialCode,
                g = t?.iso2 ?? "";
            if ((n && this.#B(g), this.selectedCountry)) {
                const C = g && $ ? `${S.FLAG} iti__${g}` : `${S.FLAG} ${S.GLOBE}`;
                let y, v, L;
                (g
                    ? ((v = a),
                      (y = o.selectedCountryAriaLabel
                          .replace("${countryName}", a)
                          .replace("${dialCode}", `+${p}`)),
                      (L = $ ? "" : G0()))
                    : ((v = o.noCountrySelected), (y = o.noCountrySelected), (L = G0())),
                    (this.selectedCountryInner.className = C),
                    this.selectedCountry.setAttribute("title", v),
                    this.selectedCountry.setAttribute(A.LABEL, y),
                    (this.selectedCountryInner.innerHTML = L));
            }
            if (r) {
                const C = p ? `+${p}` : "";
                ((this.#v.textContent = C), this.#w());
            }
        }
    },
    k2 = (s) => {
        const { onlyCountries: t, excludeCountries: n } = s;
        return t?.length
            ? T1.filter(($) => t.includes($.iso2))
            : n?.length
              ? T1.filter(($) => !n.includes($.iso2))
              : [...T1];
    },
    G2 = (s, t) => {
        const { countryNameLocale: n, i18n: $ } = t;
        let r;
        try {
            typeof Intl < "u" && typeof Intl.DisplayNames == "function"
                ? (r = new Intl.DisplayNames(n, {
                      type: "region",
                  }))
                : (r = null);
        } catch (o) {
        ...
        for (const o of s) o.name = $[o.iso2] || r?.of(o.iso2.toUpperCase()) || "";
    },
    W2 = (s) => {
        const t = new Set();
        let n = 0;
        const $ = {},
            r = (a, p) => {
                if (!a || !p) return;
                (p.length > n && (n = p.length), Object.hasOwn($, p) || ($[p] = []));
                const g = $[p];
                g.includes(a) || g.push(a);
            },
            o = [...s].sort((a, p) => a.priority - p.priority);
        for (const a of o) {
            t.has(a.dialCode) || t.add(a.dialCode);
            for (let p = 1; p < a.dialCode.length; p++) {
                const g = a.dialCode.substring(0, p);
                r(a.iso2, g);
            }
            if ((r(a.iso2, a.dialCode), a.areaCodes)) {
                const p = $[a.dialCode][0];
                for (const g of a.areaCodes) {
                    for (let C = 1; C < g.length; C++) {
                        const y = g.substring(0, C),
                            v = a.dialCode + y;
                        (r(p, v), r(a.iso2, v));
                    }
                    r(a.iso2, a.dialCode + g);
                }
            }
        }
        return {
    ...
    V2 = (s, t) => {
        ...
        s.sort(($, r) => {
            if (n) {
                const o = n.indexOf($.iso2),
                    a = n.indexOf(r.iso2),
                    p = o > -1,
                    g = a > -1;
                if (p || g) return p && g ? o - a : p ? -1 : 1;
            }
            return $.name.localeCompare(r.name);
        });
    },
    K2 = (s) => {
        for (const t of s)
            ((t.normalisedName = J1(t.name)),
                (t.initials = t.normalisedName
                    .split(/[^a-z]/)
                    .map((n) => n[0])
                    .join("")),
                (t.dialCodePlus = `+${t.dialCode}`));
    },
    j2 = new Set(["800", "808", "870", "881", "882", "883", "888", "979"]),
    V0 = (s) => {
        const t = l1(s).slice(0, 3);
        return s.startsWith("+") && j2.has(t);
    },
    K0 = (s, t, n, $) => {
        if (!n || !t) return s;
        const r = `+${$.dialCode}`,
            o = s[r.length] === " " || s[r.length] === "-" ? r.length + 1 : r.length;
        return s.substring(o);
    },
    Y2 = (s, t, n, $, r) => {
        const o = n ? n.formatNumberAsYouType(s, $?.iso2) : s,
            a = $?.dialCode;
        return r && t.charAt(0) !== "+" && o.includes(`+${a}`)
            ? (o.split(`+${a}`)[1] || "").trim()
            : o;
    },
    q2 = (s, t, n, $) => {
        ...
        for (let o = 0; o < t.length; o++) {
            if ((/[+0-9]/.test(t[o]) && r++, r === s && !$)) return o + 1;
            if ($ && r === s + 1) return o;
        }
        return t.length;
    },
    ...
    j0 = (s) => {
        const t = l1(s);
        if (t.startsWith(J0.NANP) && t.length >= 4) {
    ...
    X2 = class {
        ...
        denormalise(s) {
            if (!this.#d || this.#d === "ascii") return s;
            const t = this.#d === "arabic-indic" ? 1632 : 1776;
            return s.replace(/[0-9]/g, (n) => String.fromCharCode(t + Number(n)));
        }
        normalise(s) {
            if (!s) return "";
            if ((this.#t(s), this.#d === "ascii")) return s;
            const t = this.#d === "arabic-indic" ? 1632 : 1776,
                n = this.#d === "arabic-indic" ? /[\u0660-\u0669]/g : /[\u06F0-\u06F9]/g;
            return s.replace(n, ($) => String.fromCharCode(48 + ($.charCodeAt(0) - t)));
        }
        isAscii() {
            return !this.#d || this.#d === "ascii";
        }
    },
    z2 = 0,
    r1 = (s) => {
        if (!E.utils)
            throw new Error(
                `intlTelInput.utils is required for ${s}(). See: https://intl-tel-input.com/docs/utils`,
            );
    },
    Y0 = () => {
        let s, t;
    ...
    q1 = class y1 {
        ...
        constructor(t, n = {}) {
            ...
            ((this.#t = {
                ...
                P2(this.#t),
                R2(this.#t),
                (this.#d = new W0(t, this.#t, this.id)),
                (this.#m = typeof navigator < "u" && /Android/i.test(navigator.userAgent)),
                (this.#s = new X2(t.value)),
                (this.promise = this.#O(this.#t)),
                (this.#l = k2(this.#t)));
            const { dialCodes: r, dialCodeMaxLen: o, dialCodeToIso2Map: a } = W2(this.#l);
            ((this.#y = r),
                (this.#h = o),
                (this.#p = a),
                (this.#v = new Map(this.#l.map((p) => [p.iso2, p]))),
                this.#P());
        }
        #o() {
            const t = this.#d.telInput.value.trim();
            return this.#s.normalise(t);
        }
        #f(t) {
            this.#d.telInput.value = this.#s.denormalise(t);
        }
        #O(t) {
            const { initialCountry: n, geoIpLookup: $, loadUtils: r } = t,
                o = n === K1.AUTO && !!$,
                a = !!r && !E.utils;
            return (
                o && (this.#r = Y0()),
                a && (this.#c = Y0()),
                Promise.all([this.#r?.promise, this.#c?.promise]).then(() => {})
            );
        }
        #P() {
            ((this.#a = new AbortController()),
                this.#R(),
                this.#d.generateMarkup(this.#l),
                this.#L(),
                this.#d.maybeEnsureDropdownWidthSet(),
                this.#w(),
                this.#x(),
                this.#t.dropdownAlwaysOpen && this.#D());
        }
        #R() {
            (G2(this.#l, this.#t), V2(this.#l, this.#t), K2(this.#l));
        }
        #L(t = !1) {
            const n = this.#d.telInput.getAttribute("value"),
                $ = this.#s.normalise(n ?? ""),
                r = this.#o(),
                a = $ && $.startsWith("+") && (!r || !r.startsWith("+")) ? $ : r,
                p = this.#T(a),
                g = j0(a),
                { initialCountry: C, geoIpLookup: y } = this.#t,
                L = C === K1.AUTO && y && !t,
                w = E1(C);
            (p
                ? g
        ...
        #w() {
            (this.#B(),
                this.#t.allowDropdown && this.#M(),
                (this.#d.hiddenInputPhone || this.#d.hiddenInputCountry) &&
                    this.#d.telInput.form &&
                    this.#F());
        }
        #F() {
            const t = () => {
                (this.#d.hiddenInputPhone && (this.#d.hiddenInputPhone.value = this.getNumber()),
                    this.#d.hiddenInputCountry &&
                        (this.#d.hiddenInputCountry.value = this.#e?.iso2 || ""));
            };
            this.#d.telInput.form?.addEventListener("submit", t, {
        ...
        #M() {
            const t = this.#a.signal,
                n = (a) => {
                    this.#d.isDropdownClosed() ? this.#d.telInput.focus() : a.preventDefault();
                },
                $ = this.#d.telInput.closest("label");
            $ &&
                $.addEventListener("click", n, {
                    signal: t,
                });
            const r = () => {
                this.#d.isDropdownClosed() &&
                    !this.#d.telInput.disabled &&
                    !this.#d.telInput.readOnly &&
                    this.#D();
            };
            this.#d.selectedCountry.addEventListener("click", r, {
                signal: t,
            });
            const o = (a) => {
                const p = [H.ARROW_UP, H.ARROW_DOWN, H.SPACE, H.ENTER];
                (this.#d.isDropdownClosed() &&
                    p.includes(a.key) &&
                    (a.preventDefault(), a.stopPropagation(), this.#D()),
                    a.key === H.TAB && this.#I());
            };
            this.#d.countryContainer.addEventListener("keydown", o, {
                signal: t,
            });
        }
        #x() {
            if (this.#c) {
                const { loadUtils: t } = this.#t,
                    n = () => {
                        E.attachUtils(t)?.catch(() => {});
                    };
                E.documentReady()
                    ? n()
            ...
            this.#r && (this.#e ? this.#r.resolve() : this.#A());
        }
        #A() {
            if (E.autoCountry) {
                this.#X();
            ...
            if (
                (this.#d.selectedCountryInner.classList.add(S.LOADING),
                !E.startedLoadingAutoCountry &&
                    ((E.startedLoadingAutoCountry = !0), typeof this.#t.geoIpLookup == "function"))
            ) {
                const t = ($ = "") => {
                        this.#d.selectedCountryInner.classList.remove(S.LOADING);
                        const r = $.toLowerCase();
                        E1(r)
                            ? ((E.autoCountry = r),
                              setTimeout(() => y1.forEachInstance("handleAutoCountry")))
                            : y1.forEachInstance("handleAutoCountryFailure");
                    },
                    n = () => {
                        (this.#d.selectedCountryInner.classList.remove(S.LOADING),
                            y1.forEachInstance("handleAutoCountryFailure"));
                    };
                this.#t.geoIpLookup(t, n);
            }
        }
        #E() {
            (this.#D(), (this.#d.searchInput.value = "+"), this.#d.filterCountriesByQuery(""));
        }
        #B() {
        ...
        #U() {
            ...
            let a = !1;
            d1.ALPHA_UNICODE.test(this.#o()) && (a = !0);
            const p = (g) => {
                const C = this.#o();
                if (this.#m && g?.data === "+" && $ && r && o) {
                    const O = this.#d.telInput.selectionStart || 0,
                        T = C.substring(0, O - 1),
                        b = C.substring(O);
                    (this.#f(T + b), this.#E());
                    return;
                ...
                this.#G(C) && this.#_();
                const y = g?.data && d1.NON_PLUS_NUMERIC.test(g.data),
                    v = g?.inputType === M0.PASTE && C;
                y || (v && !t) ? (a = !0) : d1.NON_PLUS_NUMERIC.test(C) || (a = !1);
                const L = g?.detail && g.detail.isSetNumber,
                    w = this.#s.isAscii();
                if (n && !a && !L && w) {
                    const O = this.#d.telInput.selectionStart || 0,
                        b = C.substring(0, O).replace(d1.NON_PLUS_NUMERIC_GLOBAL, "").length,
                        K = g?.inputType === M0.DELETE_FWD,
                        _ = this.#g(),
                        j = Y2(_, C, E.utils, this.#e, $),
                        G = q2(b, j, O, K);
                    (this.#f(j), this.#d.telInput.setSelectionRange(G, G));
                }
                if ($ && C.startsWith("+") && this.#e?.dialCode) {
                    const O = K0(C, !0, $, this.#e);
                    this.#f(O);
                }
            };
            this.#d.telInput.addEventListener("input", p, {
                signal: this.#a.signal,
            });
        }
        #N() {
            ...
            if (!t && !n) return;
            const o = (a) => {
                if (!a.key || a.key.length !== 1 || a.altKey || a.ctrlKey || a.metaKey) return;
                if (n && $ && r && a.key === "+") {
                    (a.preventDefault(), this.#E());
                    return;
                }
                if (!t) return;
                const p = this.#o(),
                    C =
                        !p.startsWith("+") &&
                        this.#d.telInput.selectionStart === 0 &&
                        a.key === "+",
                    y = this.#s.normalise(a.key),
                    v = /^[0-9]$/.test(y),
                    L = n ? v : C || v,
                    w = this.#d.telInput,
                    O = w.selectionStart,
                    T = w.selectionEnd,
                    b = p.slice(0, O ?? void 0),
                    K = p.slice(T ?? void 0),
                    _ = b + a.key + K,
                    j = this.#g(_);
                let G = !1;
                E.utils &&
                    this.#n &&
                    (G = E.utils.getCoreNumber(j, this.#e?.iso2).length > this.#n);
                const P = this.#V(j) !== null;
                (!L || (G && !P && !C)) && a.preventDefault();
            };
            this.#d.telInput.addEventListener("keydown", o, {
                signal: this.#a.signal,
            });
        }
        #H() {
            if (!this.#t.strictMode) return;
            const t = (n) => {
                n.preventDefault();
                const $ = this.#d.telInput,
                    r = $.selectionStart,
                    o = $.selectionEnd,
                    a = this.#o(),
                    p = a.slice(0, r ?? void 0),
                    g = a.slice(o ?? void 0),
                    C = this.#e?.iso2,
                    y = n.clipboardData.getData("text"),
                    v = this.#s.normalise(y),
                    L = r === 0 && o > 0,
                    w = !a.startsWith("+") || L,
                    O = v.replace(d1.NON_PLUS_NUMERIC_GLOBAL, ""),
                    T = O.startsWith("+"),
                    b = O.replace(/\+/g, ""),
                    K = T && w ? `+${b}` : b;
                let _ = p + K + g;
                if (_.length > 5 && E.utils) {
                    let G = E.utils.getCoreNumber(_, C);
                    for (; G.length === 0 && _.length > 0; )
                        ((_ = _.slice(0, -1)), (G = E.utils.getCoreNumber(_, C)));
                    if (!G) return;
                    if (this.#n && G.length > this.#n)
                        if ($.selectionEnd === a.length) {
                            const a1 = G.length - this.#n;
                            _ = _.slice(0, _.length - a1);
                        } else return;
                }
                this.#f(_);
                const j = r + K.length;
            ...
            this.#d.telInput.addEventListener("paste", t, {
                signal: this.#a.signal,
            });
        }
        #k(t) {
            const n = Number(this.#d.telInput.getAttribute("maxlength"));
            return n && t.length > n ? t.substring(0, n) : t;
        }
        #b(t, n = {}) {
            const $ = new CustomEvent(t, {
                bubbles: !0,
                cancelable: !0,
                detail: n,
            });
            this.#d.telInput.dispatchEvent($);
        }
        #D() {
            const { dropdownContainer: t, useFullscreenPopup: n } = this.#t;
            if (((this.#i = new AbortController()), this.#d.openDropdown(), !n && t)) {
                const $ = () => this.#I();
                window.addEventListener("scroll", $, {
                    signal: this.#i.signal,
                });
            }
            (this.#J(), this.#b(b1.OPEN_COUNTRY_DROPDOWN));
        }
        #J() {
            const t = this.#i.signal;
            (this.#Q(t),
                this.#d1(t),
                this.#t.dropdownAlwaysOpen || this.#t1(t),
                this.#e1(t),
                this.#t.countrySearch && this.#n1(t));
        }
        #Q(t) {
            const n = ($) => {
                const r = $.target?.closest(`.${S.COUNTRY_ITEM}`);
                r && this.#d.highlightListItem(r, !1);
            };
            this.#d.countryList.addEventListener("mouseover", n, {
                signal: t,
            });
        }
        #d1(t) {
            ...
            this.#d.countryList.addEventListener("click", n, {
                signal: t,
            });
        }
        #t1(t) {
            const n = ($) => {
                $.target.closest(`#iti-${this.id}__dropdown-content`) || this.#I();
            };
            setTimeout(() => {
        ...
        #e1(t) {
            let n = "",
                $ = null;
            const r = (o) => {
                ([H.ARROW_UP, H.ARROW_DOWN, H.ENTER, H.ESC].includes(o.key) &&
                    (o.preventDefault(),
                    o.stopPropagation(),
                    o.key === H.ARROW_UP || o.key === H.ARROW_DOWN
                        ? this.#d.handleUpDownKey(o.key)
                        : o.key === H.ENTER && !o.isComposing
                          ? this.#i1()
                          : o.key === H.ESC && (this.#I(), this.#d.selectedCountry.focus())),
                    !this.#t.countrySearch &&
                        d1.HIDDEN_SEARCH_CHAR.test(o.key) &&
                        (o.stopPropagation(),
                        $ && clearTimeout($),
                        (n += o.key.toLowerCase()),
                        this.#$1(n),
        ...
        #n1(t) {
            (this.#d.searchInput.addEventListener("input", () => this.#d.handleSearchChange(), {
                signal: t,
            }),
                this.#d.searchClearButton.addEventListener(
                    "click",
                    () => this.#d.handleSearchClear(),
                    {
                        signal: t,
                    },
                ));
        ...
        #$1(t) {
            const n = x2(this.#l, t);
            if (n) {
                const $ = n.nodeById[this.id];
                (this.#d.highlightListItem($, !1), this.#d.scrollCountryListToItem($));
            }
        }
        #i1() {
            this.#d.highlightedItem && this.#j(this.#d.highlightedItem);
        }
        #S(t) {
            const { formatOnDisplay: n, nationalMode: $, separateDialCode: r } = this.#t;
            let o = t;
            if (n && E.utils && this.#e) {
                const a = V0(t),
                    p = ($ && !a) || (!o.startsWith("+") && !r),
                    { NATIONAL: g, INTERNATIONAL: C } = E.utils.numberFormat,
                    y = p ? g : C;
                o = E.utils.formatNumber(o, this.#e?.iso2, y);
            }
            ((o = this.#q(o)), this.#f(o));
        }
        #G(t) {
            const n = this.#V(t);
            return n !== null ? this.#C(n) : !1;
        }
        #s1(t) {
            const n = this.#e?.dialCode,
                $ = this.#e?.nationalPrefix;
            if (t.startsWith("+") || !n) return t;
            const a = $ && t.startsWith($) && !this.#t.separateDialCode ? t.substring(1) : t;
            return `+${n}${a}`;
        }
        #V(t) {
            const n = t.indexOf("+");
            let $ = n > 0 ? t.substring(n) : t;
            const r = this.#e?.iso2,
                o = this.#e?.dialCode;
            $ = this.#s1($);
            const a = this.#T($, !0),
            ...
            if (a) {
                const g = l1(a),
                    C = this.#p[g];
                if (C.length === 1) return C[0] === r ? null : C[0];
                if (!r && this.#u && C.includes(this.#u)) return this.#u;
                if (o === J0.NANP && j0(p)) return null;
                const v = this.#e?.areaCodes,
                    L = this.#e?.priority;
                if (v) {
                    const K = v.map((_) => `${o}${_}`);
                    for (const _ of K) if (p.startsWith(_)) return null;
                }
                const O = v && !(L === 0) && p.length > g.length,
                    T = r && C.includes(r) && !O,
                    b = r === C[0];
                if (!T && !b) return C[0];
            } else if ($.startsWith("+") && p.length) {
                const g = this.#e?.dialCode || "";
                return g && g.startsWith(p) ? null : "";
            } else if ((!$ || $ === "+") && !r && this.#u) return this.#u;
            return null;
        }
        #C(t) {
            const n = this.#e?.iso2 || "";
            return (
                (this.#e = t ? this.#v.get(t) : null),
                this.#e && (this.#u = this.#e.iso2),
                this.#d.setCountry(this.#e),
                this.#W(),
                this.#K(),
                n !== t
            );
        ...
        #K() {
            const { strictMode: t, placeholderNumberType: n, allowedNumberTypes: $ } = this.#t;
            if (!t || !E.utils) return;
            const r = this.#e?.iso2;
            if (!r) {
                this.#n = null;
            ...
            const o = E.utils.numberType[n];
            let a = E.utils.getExampleNumber(r, !1, o, !0),
                p = a;
            for (; E.utils.isPossibleNumber(a, r, $); ) ((p = a), (a += "0"));
            const g = E.utils.getCoreNumber(p, r);
            ((this.#n = g.length), r === "by" && (this.#n = g.length + 1));
        }
        #W() {
            const {
                    autoPlaceholder: t,
                ...
                o = t === _1.AGGRESSIVE || (!this.#d.hadInitialPlaceholder && t === _1.POLITE);
            if (!E.utils || !o) return;
            const a = E.utils.numberType[n];
            let p = this.#e ? E.utils.getExampleNumber(this.#e.iso2, $, a) : "";
            ((p = this.#q(p)),
                typeof r == "function" && (p = r(p, this.#e)),
                this.#d.telInput.setAttribute("placeholder", p));
        }
        #j(t) {
            const n = t.dataset[B0.COUNTRY_CODE],
                $ = this.#C(n);
            this.#I();
            const r = t.dataset[B0.DIAL_CODE];
            if ((this.#Y(r), this.#t.formatOnDisplay)) {
                const o = this.#o();
                this.#S(o);
            }
            (this.#d.telInput.focus(), $ && this.#_());
        }
        #I(t) {
            this.#d.isDropdownClosed() ||
                (this.#t.dropdownAlwaysOpen && !t) ||
                (this.#d.closeDropdown(),
                this.#i.abort(),
                (this.#i = null),
                this.#b(b1.CLOSE_COUNTRY_DROPDOWN));
        }
        #Y(t) {
            const n = this.#o();
        ...
        #T(t, n) {
            ...
            for (let a = 0; a < t.length; a++) {
                ...
                if (((r += p), !!!this.#p[r])) break;
                if (this.#y.has(r)) {
                    if ((($ = t.substring(0, a + 1)), (o = !0), !n)) break;
                } else n && o && ($ = t.substring(0, a + 1));
                if (r.length === this.#h) break;
            }
            return $;
        }
        #g(t) {
            const n = t ? this.#s.normalise(t) : this.#o(),
                $ = this.#e?.dialCode;
            let r;
            const o = l1(n);
            return (
                this.#t.separateDialCode && !n.startsWith("+") && $ && o
                    ? (r = `+${$}`)
                    : (r = ""),
                r + n
            );
        ...
        #q(t) {
            const n = !!this.#T(t),
                $ = K0(t, n, this.#t.separateDialCode, this.#e);
            return this.#k($);
        }
        #Z() {
            const t = this.#e;
            if (!t) return null;
            const { iso2: n, dialCode: $, name: r } = t;
            return {
                iso2: n,
                dialCode: $,
                name: r,
        ...
        #_() {
            const t = this.#Z();
            this.#b(b1.COUNTRY_CHANGE, t);
        }
        #X() {
            if (!this.#r || !E.autoCountry) return;
            if (this.#$) {
                this.#r.resolve();
                return;
            }
            ((this.#u = E.autoCountry),
                this.#e ||
                    this.#d.selectedCountryInner.classList.contains(S.GLOBE) ||
                    this.setCountry(this.#u),
                this.#r.resolve());
        }
        #r1() {
            if (this.#$) {
        ...
        #o1() {
            ...
            const t = this.#o();
            (t && this.#S(t), this.#e && (this.#W(), this.#K()), this.#c?.resolve());
        }
        #l1(t) {
            if (this.#$) {
                this.#c?.reject(t);
        ...
        destroy() {
            this.#$ ||
                ((this.#$ = !0),
                this.#t.allowDropdown && this.#I(!0),
                this.#a.abort(),
                this.#d.destroy(),
                E.instances.delete(String(this.id)));
        }
        isActive() {
            return !this.#$;
        }
        getExtension() {
            return this.#$
                ? ""
                : (r1("getExtension"), E.utils.getExtension(this.#g(), this.#e?.iso2));
        }
        getNumber(t) {
            if (this.#$) return "";
            r1("getNumber");
            const n = this.#e?.iso2,
                $ = this.#g(),
                r = E.utils.formatNumber($, n, t);
            return this.#s.denormalise(r);
        }
        getNumberType() {
            return this.#$
                ? x0.UNKNOWN_NUMBER_TYPE
                : (r1("getNumberType"), E.utils.getNumberType(this.#g(), this.#e?.iso2));
        }
        getSelectedCountryData() {
            return this.#Z();
        }
        getValidationError() {
            if (this.#$) return x0.UNKNOWN_VALIDATION_ERROR;
            r1("getValidationError");
            const t = this.#e?.iso2;
            return E.utils.getValidationError(this.#g(), t);
        }
        isValidNumber() {
            if (this.#$) return null;
            r1("isValidNumber");
            const t = this.#e?.dialCode,
                n = this.#e?.iso2,
                $ = this.#g(),
                r = E.utils.getCoreNumber($, n);
            if (r) {
                if (
                    t === k1.DIAL_CODE &&
                    r[0] === k1.MOBILE_PREFIX &&
                    r.length !== k1.MOBILE_CORE_LENGTH
                )
                    return !1;
                if (!d1.ALPHA_UNICODE.test($) && t) {
                    const a = $.startsWith("+") ? $.slice(1 + t.length) : $,
                        p = l1(a).length;
        ...
        isValidNumberPrecise() {
            return this.#$ ? null : (r1("isValidNumberPrecise"), this.#z(!0));
        }
        #u1(t) {
            return E.utils
                ? E.utils.isPossibleNumber(t, this.#e?.iso2, this.#t.allowedNumberTypes)
                : null;
        }
        #z(t) {
            const { allowNumberExtensions: n, allowPhonewords: $ } = this.#t,
                r = (g) => (t ? this.#a1(g) : this.#u1(g)),
                o = this.#g();
            if ((!this.#e && !V0(o)) || !r(o)) return !1;
            if (o.search(d1.ALPHA_UNICODE) > -1) {
                const g = this.#e?.iso2;
                return E.utils.getExtension(o, g) ? n : $;
            }
            return !0;
        }
        #a1(t) {
            return E.utils
                ? E.utils.isValidNumber(t, this.#e?.iso2, this.#t.allowedNumberTypes)
                : null;
        }
        setCountry(t) {
            if (this.#$) return;
            const n = t?.toLowerCase();
            if (!E1(n)) throw new Error(`Invalid country code: '${n}'`);
            const $ = this.#e?.iso2;
            if ((t && n !== $) || (!t && $)) {
                if ((this.#C(n), this.#Y(this.#e?.dialCode || ""), this.#t.formatOnDisplay)) {
                    const o = this.#o();
                    this.#S(o);
                }
                this.#_();
        ...
        setPlaceholderNumberType(t) {
            this.#$ || ((this.#t.placeholderNumberType = t), this.#W());
        }
        setDisabled(t) {
            this.#$ ||
                ((this.#d.telInput.disabled = t),
                this.#d.selectedCountry &&
                    (t
                        ? this.#d.selectedCountry.setAttribute("disabled", "true")
                        : this.#d.selectedCountry.removeAttribute("disabled")));
        }
        setReadonly(t) {
            this.#d.telInput &&
                ((this.#d.telInput.readOnly = t),
                this.#d.selectedCountry &&
                    (t
                        ? this.#d.selectedCountry.setAttribute("disabled", "true")
                        : this.#d.selectedCountry.removeAttribute("disabled")));
    ...
    J2 = (s) => {
        if (!E.utils && !E.startedLoadingUtilsScript) {
            let t;
            if (typeof s == "function")
                ...
                return Promise.reject(
                    new TypeError(
                        `The argument passed to attachUtils must be a function that returns a promise for the utilities module, not ${typeof s}`,
                    ),
                );
            return (
                ...
                t
                    .then((n) => {
                        ...
                        return ((E.utils = $), q1.forEachInstance("handleUtils"), !0);
                    })
                    .catch((n) => {
                        throw (q1.forEachInstance("handleUtilsFailure", n), n);
                    })
            );
        }
        return null;
    ...
    E = Object.assign(
        (s, t) => {
            const n = new q1(s, t);
            return (E.instances.set(String(n.id), n), (s.iti = n), n);
        },
        {
            defaults: z1,
            ...
            getCountryData: () => T1,
            getInstance: (s) => {
                const t = s.dataset.intlTelInputId;
                return t ? (E.instances.get(t) ?? null) : null;
            },
            instances: new Map(),
            attachUtils: J2,
...
(function () {
    ...
    function t(d, e) {
        d = d.split(".");
        var i = s;
        d[0] in i || typeof i.execScript > "u" || i.execScript("var " + d[0]);
        for (var l; d.length && (l = d.shift()); )
            d.length || e === void 0
                ? i[l] && i[l] !== Object.prototype[l]
                    ? (i = i[l])
                    : (i = i[l] = {})
                : (i[l] = e);
    }
        ...
        ((i.prototype = e.prototype),
            ...
            (d.ta = function (l, u, c) {
                for (var h = Array(arguments.length - 2), f = 2; f < arguments.length; f++)
                    h[f - 2] = arguments[f];
                return e.prototype[u].apply(l, h);
            }));
    }
    function $(d) {
        const e = [];
        let i = 0;
        for (const l in d) e[i++] = d[l];
        return e;
    }
    var r = class {
            constructor(d) {
    ...
    class v {
        constructor() {
            ...
            if (y !== y) throw Error("SafeHtml is not meant to be built directly");
            this.g = e;
        }
        toString() {
            return this.g.toString();
    ...
    ((P.prototype.has = function (d) {
        ...
        (P.prototype.equals = function (d) {
            if (!d || this.constructor != d.constructor) return !1;
            for (var e = a1(this.m()), i = 0; i < e.length; i++) {
                var l = e[i],
                    u = l.g;
                if (R(this, u) != R(d, u)) return !1;
                if (R(this, u)) {
                    var c = l.h == 11 || l.h == 10,
                        h = U(this, u);
                    if (((u = U(d, u)), l.l)) {
                        ...
                        for (l = 0; l < h.length; l++) {
                            var f = h[l],
                                I = u[l];
                            if (c ? !f.equals(I) : f != I) return !1;
                        }
                    } else if (c ? !h.equals(u) : h != u) return !1;
                }
            }
            return !0;
        }));
    function P1(d, e) {
        for (var i = a1(d.m()), l = 0; l < i.length; l++) {
            var u = i[l],
                c = u.g;
            if (R(e, c)) {
                d.g && delete d.g[u.g];
                ...
                if (u.l) {
                    u = U(e, c) || [];
                    for (var f = 0; f < u.length; f++) d0(d, c, h ? u[f].clone() : u[f]);
                } else
                    ((u = U(e, c)),
                        h ? ((h = U(d, c)) ? P1(h, u) : x(d, c, u.clone())) : x(d, c, u));
            }
        }
    }
    ...
    function U(d, e) {
        ...
        if (d.l) {
            if (!(e in d.g)) {
                ...
                if (i != null)
                    if (u.l) {
                        for (var c = [], h = 0; h < i.length; h++) c[h] = l.h(u, i[h]);
                        i = c;
                    } else i = l.h(u, i);
                return (d.g[e] = i);
            }
    ...
    function m(d, e, i) {
        var l = U(d, e);
        return d.j[e].l ? l[i || 0] : l;
    }
    function F(d, e) {
        if (R(d, e)) d = m(d, e);
        else
            d: {
                if (((d = d.j[e]), d.j === void 0))
                    if (((e = d.u), e === Boolean)) d.j = !1;
    ...
    function z(d, e) {
        return d.j[e].l ? (R(d, e) ? d.h[e].length : 0) : R(d, e) ? 1 : 0;
    }
    function x(d, e, i) {
        ((d.h[e] = i), d.g && (d.g[e] = i));
    }
    function d0(d, e, i) {
        (d.h[e] || (d.h[e] = []), d.h[e].push(i), d.g && delete d.g[e]);
    }
    function I1(d, e) {
        var i = [],
            l;
        for (l in e) l != 0 && i.push(new L(l, e[l]));
        return new G(d, i);
    }
    function v1() {}
    ((v1.prototype.g = function (d) {
        throw (new d.h(), Error("Unimplemented"));
    }),
        (v1.prototype.h = function (d, e) {
            if (d.h == 11 || d.h == 10) return e instanceof P ? e : this.g(d.u.prototype.m(), e);
            if (d.h == 14)
                return typeof e == "string" && t0.test(e) && ((d = Number(e)), d > 0) ? d : e;
            if (!d.o) return e;
            if (((d = d.u), d === String)) {
                ...
                d === Number &&
                typeof e == "string" &&
                (e === "Infinity" || e === "-Infinity" || e === "NaN" || t0.test(e))
            )
                return Number(e);
            return e;
        }));
    ...
    function R1() {}
    (n(R1, v1),
        (R1.prototype.g = function (d, e) {
            return ((d = new d.h()), (d.l = this), (d.h = e), (d.g = {}), d);
        }));
    function c1() {}
    (n(c1, R1),
        (c1.prototype.h = function (d, e) {
            return d.h == 8 ? !!e : v1.prototype.h.apply(this, arguments);
        }),
        (c1.prototype.g = function (d, e) {
            return c1.na.g.call(this, d, e);
        }));
    function M(d, e) {
    ...
    ((M.prototype.h = ""),
        ...
        (M.prototype.g = function (d, e, i) {
            if (((this.h += String(d)), e != null))
                for (let l = 1; l < arguments.length; l++) this.h += arguments[l];
            return this;
        }));
    function k(d) {
        d.h = "";
    ...
    var h1 = {
        ...
        s0 = {
            ...
            CD: [
                ,
                [, , "(?:(?:[189]|5\\d)\\d|2)\\d{7}|[1-68]\\d{6}", , , , , , , [7, 8, 9, 10]],
            ...
            CO: [
                ,
                [, , "(?:46|60\\d\\d)\\d{6}|(?:1\\d|[39])\\d{9}", , , , , , , [8, 10, 11], [4, 7]],
                [
                    ,
                    ,
            ...
            HR: [
                ,
                [, , "[2-69]\\d{8}|80\\d{5,7}|[1-79]\\d{7}|6\\d{6}", , , , , , , [7, 8, 9], [6]],
                [
                    ,
                    ,
            ...
            LR: [
                ,
                [, , "(?:[2457]\\d|33|88)\\d{7}|(?:2\\d|[4-6])\\d{6}", , , , , , , [7, 8, 9]],
                [, , "2\\d{7}", , , , "21234567", , , [8]],
                [
                    ,
                    ,
            ...
            LU: [
                ...
                [
                    ...
                    [, "(\\d{2})(\\d{2})(\\d{2})(\\d{1,2})", "$1 $2 $3 $4", ["20"], , "$CC $1"],
                    [
                        ,
                        "(\\d{2})(\\d{2})(\\d{2})(\\d{1,5})",
                        "$1 $2 $3 $4",
            ...
            SV: [
                ,
                [, , "[25-7]\\d{7}|(?:80\\d|900)\\d{4}(?:\\d{4})?", , , , , , , [7, 8, 11]],
                [
                    ,
                    ,
            ...
            YT: [
                ,
                [, , "(?:639\\d|7093)\\d{5}|(?:26|80|9\\d)\\d{7}", , , , , , , [9]],
    ...
    var M1 = {
        ...
        u2 = RegExp("[+＋]+"),
        p1 = RegExp("^[+＋]+"),
        r0 = RegExp("([0-9０-９٠-٩۰-۹])"),
        a2 = RegExp("[+＋0-9０-９٠-٩۰-۹]"),
        c2 = /[\\\/] *x/,
        h2 = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"),
        p2 = /(?:.*?[A-Za-z]){3}.*/,
        f2 = RegExp(
    ...
    var l0 = new RegExp("(?:" + o0() + ")$", "i"),
        ...
        y2 = /^\(?\$1\)?$/;
    function u0(d) {
        return d.length < 2 ? !1 : Y(m2, d);
    }
    function a0(d) {
        return Y(p2, d) ? S1(d, l2) : S1(d, M1);
    }
    function c0(d) {
        var e = a0(d.toString());
        (k(d), d.g(e));
    ...
    function h0(d) {
        return d != null && (z(d, 9) != 1 || i1(d)[0] != -1);
    }
    function S1(d, e) {
        for (var i = new M(), l, u = d.length, c = 0; c < u; ++c)
            ((l = d.charAt(c)), (l = e[l.toUpperCase()]), l != null && i.g(l));
        return i.toString();
    }
    function p0(d) {
        return d.length == 0 || y2.test(d);
    }
    function L1(d) {
        return d != null && isNaN(d) && d.toUpperCase() in s0;
    }
    B.prototype.format = function (d, e) {
        if (m(d, 2) == 0 && R(d, 5)) {
            var i = F(d, 5);
        ...
        i = F(d, 1);
        var l = g1(d);
        if (e == 0) return f0(i, 0, l, "");
        if (!(i in h1)) return l;
        var u = f1(this, i, m1(i));
        d =
            R(d, 3) && m(d, 3).length != 0
                ? e == 3
                    ? ";ext=" + m(d, 3)
                    : R(u, 13)
                      ? m(u, 13) + F(d, 3)
                ...
                : "";
        d: {
            u = (U(u, 20) || []).length == 0 || e == 2 ? U(u, 19) || [] : U(u, 20) || [];
            for (var c, h = u.length, f = 0; f < h; ++f) {
                c = u[f];
                var I = z(c, 3);
                if (
                    (I == 0 || l.search(m(c, 3, I - 1)) == 0) &&
                    ((I = new RegExp(m(c, 1))), Y(I, l))
                ) {
                    u = c;
                    break d;
                }
        ...
        return (
            u != null &&
                ...
                (h = F(h, 4)),
                (l =
                    e == 2 && h != null && h.length > 0
                        ? l.replace(c, u.replace(C2, h))
                        : l.replace(c, u)),
                e == 3 &&
                    ((l = l.replace(
                        RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"),
    ...
    function f1(d, e, i) {
        return i == "001" ? Q(d, "" + e) : Q(d, i);
    }
    function g1(d) {
        if (!R(d, 2)) return "";
        var e = "" + m(d, 2);
        return R(d, 4) && m(d, 4) && F(d, 8) > 0 ? Array(F(d, 8) + 1).join("0") + e : e;
    }
    function f0(d, e, i, l) {
        switch (e) {
            case 0:
    ...
    function g0(d, e) {
        var i = m0(d, e);
        return ((d = f1(d, F(e, 1), i)), d == null ? -1 : ((e = g1(e)), x1(e, d)));
    }
    function x1(d, e) {
        return V(d, m(e, 1))
            ? V(d, m(e, 5))
    ...
    function Q(d, e) {
        ...
        var i = d.g[e];
        if (i == null) {
            if (((i = s0[e]), i == null)) return null;
            ((i = new c1().g(e1.m(), i)), (d.g[e] = i));
        }
        return i;
    }
    function V(d, e) {
        var i = d.length;
        return z(e, 9) > 0 && i1(e).indexOf(i) == -1 ? !1 : Y(F(e, 2), d);
    }
    function E2(d, e) {
        var i = m0(d, e),
            l = F(e, 1),
    ...
    function m0(d, e) {
        if (e == null) return null;
        var i = F(e, 1);
        if (((i = h1[i]), i == null)) d = null;
        else if (i.length == 1) d = i[0];
        else
            d: {
                e = g1(e);
                for (var l, u = i.length, c = 0; c < u; c++) {
                    l = i[c];
                    var h = Q(d, l);
                    if (R(h, 23)) {
                        if (e.search(m(h, 23)) == 0) {
                            d = l;
                            break d;
                        }
                    } else if (x1(e, h) != -1) {
    ...
    function m1(d) {
        return ((d = h1[d]), d == null ? "ZZ" : d[0]);
    }
    function C0(d, e) {
        if (((d = Q(d, e)), d == null)) throw Error("Invalid region code: " + e);
        return F(d, 10);
    }
    function F1(d, e, i, l) {
        var u = w1(i, l),
            c = z(u, 9) == 0 ? i1(m(i, 1)) : i1(u);
        if (((u = U(u, 10) || []), l == 2))
            if (h0(w1(i, 0)))
                ((d = w1(i, 1)),
                    h0(d) &&
                        ((c = c.concat(z(d, 9) == 0 ? i1(m(i, 1)) : i1(d))),
                        c.sort(),
                        u.length == 0
                            ? (u = U(d, 10) || [])
                            : ((u = u.concat(U(d, 10) || [])), u.sort())));
            else return F1(d, e, i, 1);
        return c[0] == -1
            ? 5
            : ((e = e.length),
              u.indexOf(e) > -1
    ...
    function A1(d, e, i) {
        var l = g1(e);
        return ((e = F(e, 1)), e in h1 ? ((e = f1(d, e, m1(e))), F1(d, l, e, i)) : 1);
    }
    function y0(d, e) {
        if (((d = d.toString()), d.length == 0 || d.charAt(0) == "0")) return 0;
        for (var i, l = d.length, u = 1; u <= 3 && u <= l; ++u)
            if (((i = parseInt(d.substring(0, u), 10)), i in h1)) return (e.g(d.substring(u)), i);
        return 0;
    }
    function E0(d, e, i, l, u, c) {
        if (e.length == 0) return 0;
        e = new M(e);
        var h;
        (i != null && (h = m(i, 11)), h == null && (h = "NonMatch"));
        var f = e.toString();
        if (f.length == 0) h = 20;
        else if (p1.test(f)) ((f = f.replace(p1, "")), k(e), e.g(a0(f)), (h = 1));
        else {
            if (((f = new RegExp(h)), c0(e), (h = e.toString()), h.search(f) == 0)) {
                f = h.match(f)[0].length;
                var I = h.substring(f).match(r0);
                I && I[1] != null && I[1].length > 0 && S1(I[1], M1) == "0"
                    ? (h = !1)
                    : (k(e), e.g(h.substring(f)), (h = !0));
            } else h = !1;
            h = h ? 5 : 20;
        }
        if ((u && x(c, 6, h), h != 20)) {
            if (e.h.length <= 2) throw Error("Phone number too short after IDD");
            if (((d = y0(e, l)), d != 0)) return (x(c, 1, d), d);
        ...
        return i != null &&
            ...
            (I = e.toString()),
            I.lastIndexOf(f, 0) == 0 &&
                ((f = new M(I.substring(f.length))),
                (I = m(i, 1)),
                (I = new RegExp(F(I, 2))),
                I0(f, i, null),
                (f = f.toString()),
                (!Y(I, e.toString()) && Y(I, f)) || F1(d, e.toString(), i, -1) == 3))
            ? (l.g(f), u && x(c, 6, 10), x(c, 1, h), h)
            : (x(c, 1, 0), 0);
    }
    function I0(d, e, i) {
        var l = d.toString(),
        ...
        if (
            ...
            c != null &&
            c.length != 0 &&
            ((c = new RegExp("^(?:" + c + ")")), (u = c.exec(l)))
        ) {
            var h = RegExp,
                f = m(e, 1);
            ((f = F(f, 2)), (h = new h(f)), (f = Y(h, l)));
            var I = u.length - 1;
            ((e = m(e, 16)),
                e == null || e.length == 0 || u[I] == null || u[I].length == 0
                    ? (!f || Y(h, l.substring(u[0].length))) &&
                      (i != null && I > 0 && u[I] != null && i.g(u[1]),
                      d.set(l.substring(u[0].length)))
                    : ((l = l.replace(c, e)),
                      (!f || Y(h, l)) && (i != null && I > 0 && i.g(u[1]), d.set(l))));
        }
    }
    function n1(d, e, i) {
        if (!L1(i) && e.length > 0 && e.charAt(0) != "+")
            throw Error("Invalid country calling code");
        return v0(d, e, i, !0);
    }
    function v0(d, e, i, l) {
        ...
        var u = new M(),
            c = e.indexOf(";phone-context=");
        if (c === -1) c = null;
        else if (((c += 15), c >= e.length)) c = "";
        else {
            var h = e.indexOf(";", c);
            c = h !== -1 ? e.substring(c, h) : e.substring(c);
        }
        var f = c;
        if (
            (f == null
                ...
                : f.length === 0
                  ? (h = !1)
                  : ((h = f2.exec(f)), (f = g2.exec(f)), (h = h !== null || f !== null)),
            !h ||
                (c != null
                    ? (c.charAt(0) === "+" && u.g(c),
                      (c = e.indexOf("tel:")),
                      u.g(e.substring(c >= 0 ? c + 4 : 0, e.indexOf(";phone-context="))))
                    : ((c = u.g),
                      (h = e ?? ""),
                      (f = h.search(a2)),
                      f >= 0
                          ? ((h = h.substring(f)),
                            (h = h.replace(h2, "")),
                            (f = h.search(c2)),
                            f >= 0 && (h = h.substring(0, f)))
                          : (h = ""),
                      c.call(u, h)),
                (c = u.toString()),
                (h = c.indexOf(";isub=")),
                h > 0 && (k(u), u.g(c.substring(0, h))),
                !u0(u.toString())))
        )
            throw Error("The string supplied did not seem to be a phone number");
        if (((c = u.toString()), !(L1(i) || (c != null && c.length > 0 && p1.test(c)))))
            throw Error("Invalid country calling code");
        ((c = new J()), l && x(c, 5, e));
        d: {
            if (((e = u.toString()), (h = e.search(l0)), h >= 0 && u0(e.substring(0, h)))) {
                f = e.match(l0);
                for (var I = f.length, q = 1; q < I; ++q)
                    if (f[q] != null && f[q].length > 0) {
                        (k(u), u.g(e.substring(0, h)), (e = f[q]));
                        break d;
                    }
            }
            e = "";
        }
        (e.length > 0 && x(c, 3, e), (h = Q(d, i)), (e = new M()), (f = 0), (I = u.toString()));
        try {
            f = E0(d, I, h, e, l, c);
        } catch (H1) {
            if (H1.message == "Invalid country calling code" && p1.test(I)) {
                if (((I = I.replace(p1, "")), (f = E0(d, I, h, e, l, c)), f == 0)) throw H1;
            } else throw H1;
        }
        if (
            (f != 0
                ? ((u = m1(f)), u != i && (h = f1(d, f, u)))
                : (c0(u),
                  e.g(u.toString()),
                  i != null
                      ? ((f = F(h, 10)), x(c, 1, f))
                      : l && (delete c.h[6], c.g && delete c.g[6])),
            e.h.length < 2 ||
                (h != null &&
                    ((i = new M()),
                    (u = new M(e.toString())),
                    I0(u, h, i),
                    (d = F1(d, u.toString(), h, -1)),
                    d != 2 &&
                        d != 4 &&
                        d != 5 &&
                        ((e = u), l && i.toString().length > 0 && x(c, 7, i.toString()))),
                (l = e.toString()),
                (d = l.length),
                d < 2))
        )
        ...
        if (l.length > 1 && l.charAt(0) == "0") {
            for (x(c, 4, !0), d = 1; d < l.length - 1 && l.charAt(d) == "0"; ) d++;
            d != 1 && x(c, 8, d);
        }
        return (x(c, 2, parseInt(l, 10)), c);
    }
    function Y(d, e) {
        return !!(
            (d = e.match(
    ...
    function w0(d, e) {
        var i = d.ha;
        return ((e = L1(e) ? C0(i, e) : 0), (d = Q(d.ha, m1(e))), d ?? S0);
    }
    function F0(d) {
        for (var e = d.j.length, i = 0; i < e; ++i) {
            var l = d.j[i],
                u = F(l, 1);
            if (d.ea == u) return !1;
            var c = d,
            ...
            var I = c;
            h = F(h, 2);
            var q = "999999999999999".match(f)[0];
            if (
                (q.length < I.g.h.length
                    ? (I = "")
                    : ((I = q.replace(new RegExp(f, "g"), h)),
                      (I = I.replace(RegExp("9", "g"), " "))),
                I.length > 0 ? (c.$.g(I), (c = !0)) : (c = !1),
                c)
            )
                return ((d.ea = u), (d.ia = L0.test(m(l, 4))), (d.ba = 0), !0);
        }
        return (d.v = !1);
    }
    function A0(d, e) {
        for (var i = [], l = e.length - 3, u = d.j.length, c = 0; c < u; ++c) {
            var h = d.j[c];
            z(h, 3) == 0
                ? i.push(d.j[c])
                : ((h = m(h, 3, Math.min(l, z(h, 3) - 1))), e.search(h) == 0 && i.push(d.j[c]));
        }
        d.j = i;
    }
    function S2(d, e) {
        ...
        var i = e;
        if (
            (r0.test(i) || (d.u.h.length == 1 && u2.test(i))
                ? (e == "+" ? ((i = e), d.da.g(e)) : ((i = M1[e]), d.da.g(i), d.g.g(i)), (e = i))
                : ((d.v = !1), (d.ma = !0)),
            !d.v)
        ) {
            if (!d.ma) {
        ...
        switch (d.da.h.length) {
            ...
            case 3:
                if (_0(d)) d.fa = !0;
                else return ((d.o = T0(d)), B1(d));
            default:
                return d.fa
                    ? (O0(d) && (d.fa = !1), d.h.toString() + d.g.toString())
                    : d.j.length > 0
                      ? ((e = P0(d, e)),
                        (i = b0(d)),
                        i.length > 0
                            ? i
                            : (A0(d, d.g.toString()),
                              F0(d) ? D0(d) : d.v ? N1(d, e) : d.u.toString()))
                      : B1(d);
        }
    }
    function N0(d) {
        return ((d.v = !0), (d.fa = !1), (d.j = []), (d.ba = 0), k(d.$), (d.ea = ""), B1(d));
    }
    function b0(d) {
        for (var e = d.g.toString(), i = d.j.length, l = 0; l < i; ++l) {
            var u = d.j[l],
                c = F(u, 1);
            if (
                new RegExp("^(?:" + c + ")$").test(e) &&
                ((d.ia = L0.test(m(u, 4))),
                (u = e.replace(new RegExp(c, "g"), m(u, 2))),
                (u = N1(d, u)),
                S1(u, o2) == d.da)
            )
                return u;
    ...
    function N1(d, e) {
        var i = d.h.h.length;
        return d.ia && i > 0 && d.h.toString().charAt(i - 1) != " " ? d.h + " " + e : d.h + e;
    }
    function B1(d) {
        var e = d.g.toString();
        if (e.length >= 3) {
            for (
                ...
                var c = i[u];
                (d.o.length > 0 && p0(F(c, 4)) && !m(c, 6) && !R(c, 5)) ||
                    ((d.o.length != 0 || d.aa || p0(F(c, 4)) || m(c, 6)) &&
                        v2.test(F(c, 2)) &&
                        d.j.push(c));
            }
            return (A0(d, e), (e = b0(d)), e.length > 0 ? e : F0(d) ? D0(d) : d.u.toString());
        }
        return N1(d, e);
    }
    function D0(d) {
        var e = d.g.toString(),
            i = e.length;
        if (i > 0) {
            for (var l = "", u = 0; u < i; u++) l = P0(d, e.charAt(u));
            return d.v ? N1(d, l) : d.u.toString();
        }
        return d.h.toString();
    }
    function T0(d) {
        var e = d.g.toString(),
            i = 0;
        if (m(d.l, 10) != 1) var l = !1;
        else
            ((l = d.g.toString()),
                (l = l.charAt(0) == "1" && l.charAt(1) != "0" && l.charAt(1) != "1"));
        return (
            l
                ? ((i = 1), d.h.g("1").g(" "), (d.aa = !0))
                : R(d.l, 15) &&
                  ((l = new RegExp("^(?:" + m(d.l, 15) + ")")),
                  (l = e.match(l)),
                  l != null &&
                      l[0] != null &&
                      l[0].length > 0 &&
                      ((d.aa = !0), (i = l[0].length), d.h.g(e.substring(0, i)))),
            k(d.g),
            d.g.g(e.substring(i)),
            e.substring(0, i)
        );
    ...
    function _0(d) {
        var e = d.da.toString(),
            i = new RegExp("^(?:\\+|" + m(d.l, 11) + ")");
        return (
            (i = e.match(i)),
            i != null && i[0] != null && i[0].length > 0
                ? ((d.aa = !0),
                  (i = i[0].length),
                  k(d.g),
                  d.g.g(e.substring(i)),
    ...
    function O0(d) {
        ...
        return i == 0
            ...
            : (k(d.g),
              d.g.g(e.toString()),
              (e = m1(i)),
              e == "001" ? (d.l = Q(d.ha, "" + i)) : e != d.la && (d.l = w0(d, e)),
              d.h.g("" + i).g(" "),
              (d.o = ""),
              !0);
    }
    function P0(d, e) {
        var i = d.$.toString();
        if (i.substring(d.ba).search(d.ga) >= 0) {
            var l = i.search(d.ga);
            return (
                (e = i.replace(d.ga, e)),
                k(d.$),
    ...
    const R0 = (d) => {
            ...
            return (
                d.includes("FIXED_LINE_OR_MOBILE")
                    ? (d.includes("MOBILE") || e.push("MOBILE"),
                      d.includes("FIXED_LINE") || e.push("FIXED_LINE"))
                    : (d.includes("MOBILE") || d.includes("FIXED_LINE")) &&
                      e.push("FIXED_LINE_OR_MOBILE"),
                d.concat(e)
            );
        },
        U1 = {
    ...
    (t("utils", {}),
        t("utils.formatNumberAsYouType", (d, e) => {
            try {
                const i = d.replace(/[^+0-9]/g, ""),
                    l = new I2(e);
                e = "";
                for (let u = 0; u < i.length; u++) ((l.ka = S2(l, i.charAt(u))), (e = l.ka));
                return e;
            } catch {
                return d;
            }
        }),
        t("utils.formatNumber", (d, e, i) => {
            try {
                const u = B.g(),
                    c = n1(u, d, e);
                var l = A1(u, c, -1);
                return l == 0 || l == 4 ? u.format(c, typeof i > "u" ? 0 : i) : d;
            } catch {
                return d;
            }
        }),
        t("utils.getExampleNumber", (d, e, i, l) => {
            try {
                const I = B.g();
                d: {
                    var u = I;
        ...
        t("utils.getValidationError", (d, e) => {
            ...
            try {
                ...
                return i.message === "Invalid country calling code"
                    ? 1
                    : d.length <= 3 ||
                        i.message === "Phone number too short after IDD" ||
                        i.message === "The string supplied is too short to be a phone number"
                      ? 2
                      : i.message === "The string supplied is too long to be a phone number"
                        ? 3
                        : -99;
            }
        }),
        t("utils.isValidNumber", (d, e, i) => {
            try {
                const l = B.g(),
                    u = n1(l, d, e),
                    c = E2(l, u);
                if (i) {
                    const h = R0(i).map((f) => U1[f]);
                    return c && h.includes(g0(l, u));
                }
                return c;
            } catch {
                return !1;
        ...
        t("utils.isPossibleNumber", (d, e, i) => {
            try {
                const l = B.g(),
                    u = n1(l, d, e);
                if (i) {
                    const c = R0(i);
                    for (let h of c) if (A1(l, u, U1[h]) === 0) return !0;
                    return !1;
                }
                return A1(l, u, -1) === 0;
            } catch {
        ...
        t("utils.numberType", U1),
        t("utils.validationError", {
            IS_POSSIBLE: 0,
...
function $2(s) {
    ...
    const t = dd(s, {
        initialCountry: "ua",
        countryOrder: ["ua", "pl", "cz", "de", "es"],
        separateDialCode: !0,
        nationalMode: !1,
        strictMode: !0,
        formatAsYouType: !0,
        dropdownContainer: document.body,
        useFullscreenPopup: !0,
    });
    return (
        n2.set(s, t),
        s.addEventListener("countrychange", () => {
            s.parentElement?.classList.remove("error", "success");
        }),
        t
    );
}
function i2(s) {
    ...
    const n = t.isValidNumber() ?? !1,
        $ = n ? t.getNumber() : s.value.trim();
    return {
        ok: n,
        e164: $,
    };
}
const q0 = document.getElementById("scrollProgress");
function td() {
...
window.addEventListener("scroll", td, {
    passive: !0,
});
const ed = document.querySelectorAll(".section[id], .hero[id]"),
    nd = document.querySelectorAll(".nav-links a"),
    $d = {
        root: null,
        rootMargin: "-40% 0px -40% 0px",
        threshold: 0,
    },
    id = new IntersectionObserver((s) => {
        s.forEach((t) => {
            if (t.isIntersecting) {
                const n = t.target.id;
                nd.forEach(($) => {
                    ($.classList.remove("active"),
                        $.getAttribute("href") === `#${n}` && $.classList.add("active"));
                });
            }
        });
    }, $d);
ed.forEach((s) => id.observe(s));
const Z0 = Array.from(document.querySelectorAll("[data-reveal]")),
    sd = window.matchMedia("(prefers-reduced-motion: reduce)").matches;
if (sd) Z0.forEach((s) => s.classList.add("is-visible"));
else {
    const s = new IntersectionObserver(
        (t, n) => {
            t.forEach(($) => {
                ...
                const r = $.target,
                    o = r.dataset.delay;
                (o && r.style.setProperty("--reveal-delay", `${o}ms`),
    ...
    Z0.forEach((t) => s.observe(t));
}
const rd = document.querySelectorAll(".list"),
    od = new IntersectionObserver(
        (s) => {
            s.forEach((t) => {
                t.isIntersecting && t.target.classList.add("is-visible");
            });
        },
        {
            threshold: 0.2,
...
rd.forEach((s) => od.observe(s));
const W1 = document.querySelectorAll(".pricing-list li");
if (W1.length > 0) {
    const s = new IntersectionObserver(
        (t) => {
            t.forEach((n) => {
                n.isIntersecting &&
                    (W1.forEach(($) => $.classList.remove("is-active")),
...
function ld(s, t, n = "") {
    ...
    const a = () => {
        ((o += r),
            o < t
                ? ((s.textContent = Math.floor(o).toLocaleString() + n), requestAnimationFrame(a))
                : (s.textContent = t.toLocaleString() + n));
    };
    a();
}
const Z1 = document.querySelectorAll(".stat-number[data-count]");
let X0 = !1;
const ud = new IntersectionObserver(
    (s) => {
        s.forEach((t) => {
            t.isIntersecting &&
                !X0 &&
                ((X0 = !0),
                Z1.forEach((n) => {
                    const $ = parseInt(n.dataset.count || "0", 10),
                        r = n.dataset.suffix || "";
                    ld(n, $, r);
                }));
        });
...
Z1.length > 0 && ud.observe(Z1[0].closest(".stats-grid"));
document.querySelectorAll(".btn").forEach((s) => {
    s.addEventListener("click", function (t) {
        const n = s.getBoundingClientRect(),
            $ = document.createElement("span");
        $.classList.add("ripple");
        const r = Math.max(n.width, n.height);
        (($.style.width = $.style.height = `${r}px`),
            ($.style.left = `${t.clientX - n.left - r / 2}px`),
            ($.style.top = `${t.clientY - n.top - r / 2}px`),
            s.appendChild($),
            setTimeout(() => $.remove(), 600));
    });
});
const o1 = document.querySelector(".slider-track"),
    V1 = document.querySelector(".slider-dots"),
    ad = document.querySelector(".slider-btn--prev"),
    cd = document.querySelector(".slider-btn--next");
if (o1 && V1) {
    let s = function () {
            o1 &&
                ((o1.style.transform = `translateX(-${a * 100}%)`),
                p.forEach((y, v) => {
                    y.classList.toggle("active", v === a);
                }));
        },
        t = function (y) {
            ((a = (y + o) % o), s());
    ...
    const o = o1.querySelectorAll(".case-card").length;
    let a = 0;
    for (let y = 0; y < o; y++) {
        const v = document.createElement("button");
        (v.classList.add("slider-dot"),
            y === 0 && v.classList.add("active"),
            v.addEventListener("click", () => t(y)),
            V1.appendChild(v));
    }
    const p = V1.querySelectorAll(".slider-dot");
    (ad?.addEventListener("click", $), cd?.addEventListener("click", n));
    let g = 0,
        C = 0;
    (o1.addEventListener(
        "touchstart",
        (y) => {
            g = y.changedTouches[0].screenX;
        },
        {
            passive: !0,
        },
...
document.querySelectorAll("[data-video-player]").forEach((s) => {
    const t = s.querySelector("video"),
        n = s.querySelector(".video-play-btn"),
        $ = s.querySelector(".video-progress"),
        r = s.querySelector(".video-progress-fill"),
        o = s.querySelector(".video-time");
    !t ||
        !n ||
        !$ ||
        !r ||
        ...
        (n.addEventListener("click", () => {
            t.paused
                ? (document.querySelectorAll("[data-video-player]").forEach((a) => {
                      if (a !== s) {
                          const p = a.querySelector("video");
                          p && !p.paused && (p.pause(), a.classList.remove("playing"));
                      }
                  }),
                  t.play(),
                  s.classList.add("playing"))
                : (t.pause(), s.classList.remove("playing"));
        }),
        t.addEventListener("click", () => {
            t.paused || (t.pause(), s.classList.remove("playing"));
        }),
        t.addEventListener("timeupdate", () => {
            const a = (t.currentTime / t.duration) * 100;
            r.style.width = a + "%";
            const p = Math.floor(t.currentTime / 60),
                g = Math.floor(t.currentTime % 60)
                    .toString()
                    .padStart(2, "0");
            o.textContent = `${p}:${g}`;
        }),
        $.addEventListener("click", (a) => {
            const p = $.getBoundingClientRect(),
                g = (a.clientX - p.left) / p.width;
            t.currentTime = g * t.duration;
        }),
        t.addEventListener("ended", () => {
            s.classList.remove("playing");
        }));
});
const u1 = document.getElementById("contactModal"),
    X = document.getElementById("modalForm"),
    hd = u1?.querySelector(".modal-close"),
    pd = document.querySelectorAll("[data-open-modal]"),
    fd = X?.querySelector('input[name="phone"]') ?? null,
    gd = document.querySelector('.cta-form input[type="tel"]') ?? null;
$2(fd);
$2(gd);
function md() {
    (u1?.classList.add("active"), (document.body.style.overflow = "hidden"));
}
function Q1() {
    (u1?.classList.remove("active"), (document.body.style.overflow = ""));
}
pd.forEach((s) => {
...
hd?.addEventListener("click", Q1);
u1?.addEventListener("click", (s) => {
    s.target === u1 && Q1();
});
document.addEventListener("keydown", (s) => {
    s.key === "Escape" && u1?.classList.contains("active") && Q1();
});
if (X) {
    const s = X.querySelector(".btn-modal-submit"),
        t = X.querySelectorAll(".form-input");
    X.addEventListener("submit", async (n) => {
        n.preventDefault();
        const $ = X.querySelector('input[name="name"]'),
            r = X.querySelector('input[name="phone"]'),
            o = X.querySelector('input[name="instagram"]'),
            a = X.querySelector('input[name="budget"]:checked'),
            p = $?.value.trim() || "",
            g = i2(r),
            C = g.e164,
            y = o?.value.trim() || "",
            ...
            (t.forEach((T) => {
                ...
                if (T === r) {
                    g.ok
                        ...
                        : (b?.classList.add("error"), b?.classList.remove("success"), (L = !0));
                    return;
                }
                T.required && !T.value.trim()
                    ? (b?.classList.add("error"), (L = !0))
                    : (b?.classList.remove("error"), b?.classList.add("success"));
            }),
            L)
        )
            return;
        s && (s.classList.add("btn-loading"), (s.disabled = !0));
        const w = new AbortController(),
            O = setTimeout(() => w.abort(), 5e3);
        try {
            const T = await fetch("/api/send-lead.php", {
                method: "POST",
                headers: {
            ...
            if (b.success) window.location.href = "/thank-you.html";
            else throw new Error(b.error || "Помилка відправки");
        } catch (T) {
            if ((clearTimeout(O), T?.name === "AbortError")) {
                window.location.href = "/thank-you.html";
                return;
            }
            (s && (s.classList.remove("btn-loading"), (s.disabled = !1)),
                console.error("Modal form submission error:", T),
                s2());
        }
    });
}
const $1 = document.querySelector(".cta-form"),
    C1 = $1?.querySelector(".btn");
document.getElementById("toastSuccess");
const Cd = document.getElementById("toastError"),
    yd = "/api/send-lead.php";
function s2(s) {
    const t = Cd;
    t &&
...
if ($1 && C1) {
    const s = $1.querySelectorAll(".form-input");
    (s.forEach((t) => {
        (t.value && t.parentElement?.classList.add("has-value"),
            t.addEventListener("input", () => {
                t.value
                    ? t.parentElement?.classList.add("has-value")
                    : t.parentElement?.classList.remove("has-value");
            }));
    }),
        $1.addEventListener("submit", async (t) => {
            t.preventDefault();
            const n = $1.querySelector(`input[placeholder*="ім'я"], input[placeholder*="Ім'я"]`),
                $ = $1.querySelector('input[type="tel"]'),
                r = $1.querySelector(
                    'input[name="instagram"], input[placeholder*="інстаграм"], input[placeholder*="Instagram"], input[placeholder*="сайт"]',
                ),
                o = n?.value.trim() || "",
                a = i2($),
                p = a.e164,
            ...
            if (
                (s.forEach((L) => {
                    ...
                    if (L === $) {
                        a.ok
                            ? (w?.classList.remove("error"), w?.classList.add("success"))
                            : (w?.classList.add("error"),
                              w?.classList.remove("success"),
                              (C = !0));
                        return;
                    }
                    L.required && !L.value.trim()
                        ? (w?.classList.add("error"), (C = !0))
                        : (w?.classList.remove("error"), w?.classList.add("success"));
                }),
                C)
            )
                return;
            (C1.classList.add("btn-loading"), (C1.disabled = !0));
            const y = new AbortController(),
                v = setTimeout(() => y.abort(), 5e3);
            try {
                const L = await fetch(yd, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
                ...
                if (w.success) window.location.href = "/thank-you.html";
                else throw new Error(w.error || "Помилка відправки");
            } catch (L) {
                if ((clearTimeout(v), L?.name === "AbortError")) {
                    window.location.href = "/thank-you.html";
                    return;
                }
                (C1.classList.remove("btn-loading"),
                    (C1.disabled = !1),
